...
def plot_1d(ax, xdata, data, xlabel, line_labels, marker=None, color=None,
            logx=False, logy=False, cmap=None, colorname=None):
...
def plot_2d(ax, data, axis_labels, marker=None, color=None, logx=False,
            logy=False, cmap=None, colorname=None):
...
def plot_3d(ax, data, axis_labels, marker=None, color=None, logx=False,
            logy=False, cmap=None, colorname=None):
